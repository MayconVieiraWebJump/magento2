...
class createCarouselMagnoliaBlock implements DataPatchInterface, PatchRevertableInterface
{
    /**
    ...
    const IDENTIFIER_BLOCK = 'carrosel_magnolia_br';
    ...
    public function apply()
    {
        ...
        $this->createCarouselMagnoliaBlock("msvBR");
     ...
     */
    protected function createCarouselMagnoliaBlock(string $storeCode)
    {
        ...
        $cmsBlockData = [
            'is_active' => 1,
            'title' => 'Carroussel Magnolia pt-br',
