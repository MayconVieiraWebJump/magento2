...
class CreateFooterImageBlock implements DataPatchInterface, PatchRevertableInterface
{
    /**
    ...
    const IDENTIFIER_BLOCK = 'footer_img';
    ...
    public function apply()
    {
        ...
        $this->createFooterImageWineBlock("wsvBR");
     ...
     */
    protected function createFooterImageWineBlock(string $storeCode)
    {
